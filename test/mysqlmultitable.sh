...
$srcdir/mysqlcheck.py -c T1.EINS,,number,General -v -d alltypes -t T1 \
...
$srcdir/mysqlcheck.py -c T1.EINS,,number,General -c smallint,,number,General -v -d alltypes -t T1 -- \
...
$srcdir/mysqlcheck.py -c T1.EINS,,number,@@ -c smallint,,number,#,# -v -d alltypes -t T1 -- \
...
$srcdir/mysqlcheck.py -c T1.EINS,,number,@@ \
                      -c smallint,,number,#,# \
