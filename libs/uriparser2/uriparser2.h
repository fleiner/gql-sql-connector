...
#ifdef __cplusplus
        std::string scheme() const { return scheme_?scheme_:""; }
        std::string user() const { return user_?user_:""; }
        std::string pass() const { return pass_?pass_:""; }
        std::string host() const { return host_?host_:""; }
        unsigned short port() const { return port_; }
        std::string path() const { return path_?path_:""; }
        std::string query() const { return query_?query_:""; }
        std::string fragment() const { return fragment_?fragment_:""; }
